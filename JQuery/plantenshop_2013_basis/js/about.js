...
//alert("dom tree nog niet geladen: onmidellijke uitvoering");
...
$(function () {
    ...
    $("<a href='#about'title='terug nr boven'>terug naar boven</a>")
            .insertBefore(":header:gt(1)")
            .button({icons: {secondary: "ui-icon ui-icon-circle-triangle-n"}});
    //$('h2, h3, h4, h5, h6').before('<a href="#about">terug naar boven</a>');
...
var checkNode = function (node) {
    ...
    //enkel als elementNode, in de lijst sectionElms en geen no_toc
    var strNotoc = "no-toc";
